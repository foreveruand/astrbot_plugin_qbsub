...
| `/qb_add <关键词>` | 直接添加关键词到订阅规则 | `/qb_add keyword1,keyword2` |
| `/qb_del <关键词>` | 从订阅规则中移除关键词 | `/qb_del keyword1` |
| `/qb_list` | 列出当前订阅关键词 | `/qb_list` |
| `/qb_clean` | 清理已匹配的订阅关键词 | `/qb_clean` |
...
2. **交互简化**: 将 Telegram Inline Keyboard 替换为文本菜单 + 序号回复
3. **调度系统**: 使用 AstrBot 内置 CronJobManager 替代 APScheduler
4. **配置方式**: 使用 AstrBot 可视化配置面板
